...
from models.base import CreateUpdateBase, CreateBase


# 用户信息类
class User(CreateUpdateBase):
    __tablename__ = "user"
...
class UserChangePasswordRequest(BaseModel):
    ...
    new_password: str = Field(
        ..., min_length=6, alias="newPassword", description="新密码"
    )
